# 2026-06-22 → 06-26 问题复盘

> **事实源/设计抽象**:本周问题的根因与源码核实见第 10 章各篇(以 `origin/feature/integrate` 为准);本页只做按主题的索引,不重复正文。
>
> 本周(**2026-06-22 → 06-26**)在 aevatar 上碰到的问题索引:每条一句话根因 + 状态,详情指向第 10 章对应深度复盘。问题清单从本周 aevatar 会话收敛,少数线索上溯到上周末、已记录在 [10/02](../10/02-codex-shell-vs-aevatar-tools.md)–[10/04](../10/04-responses-llm-run-offactor-and-observation.md)。
>
