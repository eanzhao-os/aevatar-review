...
Reads .superpowers/task3/closed-issues.tsv (number<TAB>title), writes
.superpowers/task3/closed-details.json keyed by issue number with:
...
TSV = ROOT / "closed-issues.tsv"
OUT = ROOT / "closed-details.json"
