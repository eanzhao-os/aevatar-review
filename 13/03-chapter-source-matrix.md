...
| [07/02-nyxid-chat-actor-model-and-progress.md](../07/02-nyxid-chat-actor-model-and-progress.md) | `current` | `agents/Aevatar.GAgents.NyxidChat/NyxIdChatConversationGAgent.cs:18`、`:42`、`:571`; `agents/Aevatar.GAgents.NyxidChat/NyxIdChatTurnGAgent.cs:13`、`:56-63`; `docs/canon/nyxid-chat-api.md:9`、`:78-84` | E4: #2891; #2893 | `2026-07-25` |
